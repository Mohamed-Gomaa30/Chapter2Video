...
class CoderAgent:
    def __init__(self, model_platform: ModelPlatformType = ModelPlatformType.GEMINI,
        ...
        self.system_message = (
            ...
            "- Structure: \\begin{columns}[onlytextwidth,T] with {0.45\\textwidth} for text and {0.52\\textwidth} for figure.\n"
            "- Figure: \\includegraphics[width=0.52\\textwidth,height=0.8\\textheight,keepaspectratio]{<path>}. (Balanced and clear).\n\n"
